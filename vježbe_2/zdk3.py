...
# definiram parametre po stoti put koristim v0_jednoliko etc da mi je lakše razlikovati gdje je što
v0_jednoliko = 25
t_jednoliko = np.linspace(0, 10, 100)  # vremenska os od 0 do 10 sekundi s "korakom" 0.1 s
